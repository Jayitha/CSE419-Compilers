...
const int YY_parse_CLASS::EMAIL=259;
const int YY_parse_CLASS::ROLL=260;
const int YY_parse_CLASS::BRACE=261;
...
static const char * const yytname[] = {   "$","error","$illegal.","NAME","EMAIL",
"ROLL","BRACE","'\\n'","Goal",""
};
#endif
